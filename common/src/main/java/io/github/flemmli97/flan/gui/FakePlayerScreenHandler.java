        ...
        for (int i = 0; i < 54; i++) {
            if (i == 0) {
                ...
                if (id < players.size()) {
                    ...
                    fakePlayer.set(DataComponents.CUSTOM_NAME, ServerScreenHelper.coloredGuiText(String.format(ConfigHandler.LANG_MANAGER.get("screenFakePlayerNameUUID"), players.get(id)), ChatFormatting.YELLOW));
